...
public class EstudianteEjemploController : ControllerBase
{
    ...
    //Constructor
    public EstudianteEjemploController(EstudianteService service,
    ...
    {
        var estudiante = await _estudianteService.Ficha(id);
